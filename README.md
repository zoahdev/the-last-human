...
*The Complete Canon — one million words, written in English.*
...
The canon is complete at one million words. Final count: **1,002,217 words** across **353 volumes** and more than 4,200 chapters, compiled automatically into `book.md` by `build-book.ps1`.
